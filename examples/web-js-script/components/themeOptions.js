...
const updateRadioButtons = value => {
  const basicTheme = document.getElementById('basic-theme');
  const emeraldFunkTheme = document.getElementById('cb-emerald-funk-theme');
  const corbadoCustomTheme = document.getElementById('corbado-custom-theme');
...
export function insertThemeOptions(initialValue, onThemeChange) {
