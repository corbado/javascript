...
test.describe('InitSignupScreen unproductive user behavior', () => {
  test.skip('with empty username', async ({ signupFlow, page }) => {
  ...
  test.skip('with invalid username (illegal characters)', async ({ signupFlow, page }) => {
    await signupFlow.fillIdentifiers(false, true, true);
  ...
  test.skip('with invalid username (length)', async ({ signupFlow, page }) => {
    await signupFlow.fillIdentifiers(false, true, true);
  ...
  test.skip('with empty email address', async ({ signupFlow, page }) => {
  ...
  test.skip('with invalid email address', async ({ signupFlow, page }) => {
    await signupFlow.fillIdentifiers(true, false, true);
  ...
  test.skip('with empty phone number', async ({ signupFlow, page }) => {
  ...
  test.skip('with invalid phone number', async ({ signupFlow, page }) => {
    await signupFlow.fillIdentifiers(true, true, false);
